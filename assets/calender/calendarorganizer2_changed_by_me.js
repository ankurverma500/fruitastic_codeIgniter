...
Calendar.prototype.draw = function () {
  ...
  for (var i = 0; i < 6; i++) {
    ...
    theRows[i].className = "calender_row";
  }
...
Organizer.prototype.list = function (data) {
  ...
  for (var i = 0; i < data.length; i++) {
    content += '<li id="' + this.id + '-list-item-' + i + '">';
		/*content += '<div>';
		content += '<span class="' + this.id + ' time" id="' + this.id + '-list-item-' + i + '-time">' + data[i].startTime + '  ' + data[i].endTime + '</span>';
		content += '<span class="' + this.id + ' m" id="' + this.id + '-list-item-' + i + '-m">' + data[i].mTime + '</span>';
		content += '</div>';*/
		content += '<p id="' + this.id + '-list-item-' + i + '-text">' + data[i].text + '</p>';
	content += '</li>';
  }
...
/*								Oder deleted by admin, order id:- 653	
143	31-Dec-2017 12:11:39	One Order deleted	Order deleted by admin, order id:- 654	
144	31-Dec-2017 12:15:24	One Order deleted	Order deleted by admin, order id:- 633	
145	31-Dec-2017 12:15:28	One Order deleted	Order deleted by admin, order id:- 634
*/
