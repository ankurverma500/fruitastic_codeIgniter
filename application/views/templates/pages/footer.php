            ...
            <div class="row">
                <div class="footer_col4 footer_fbtns">
                    ...
                    <p>With more than 15 years of experience we can proudly say we are still leading the way in online fruit and veg in Victoria, trusted by thousands…………… </p>
                      <a href="about.html" class="btn btn-default light_gray">Read More <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                </div>
                <div class="footer_col2">
                    <h3 class="footer_heading">Information</h3>
                    <ul class="footer_links">
                        <li><a href="delivery.html">Delivery</a></li>
                        <li><a href="legel-notice.html">Legal Notice</a></li>
                ...
                <div class="footer_col1">
                    ...
                    <form class="search_from footer_form">
                      ...
                      <button type="submit" class="btn btn-default light_gray hoverd-btn">Subscribe <i class="fa fa-long-arrow-right" aria-hidden="true"></i></button>
                    </form>
                </div>
            </div>
        </div>
