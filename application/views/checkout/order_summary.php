      ...
      <table class="table">
        <tbody>
          <tr>
            ...
            <td class="clrwhite"><?php $s_charge=0; if($total_price>40){echo 'Free';}else{ echo '$8';$s_charge=8;}?></td>
          </tr>
          ...
          <tr>
            ...
            <td><strong class="clrwhite" id="order_summary_total_price" s_charge="<?php echo $s_charge;?>" total_price="<?php echo $total_price;?>">$<?php echo ($total_price+$s_charge)?></strong></td>
          </tr>
        </tbody>
      </table>
      <div class="row">
        <div class="col-sm-12" id="discount_div_id">
          ...
          <div class="input-group1 input-group-sm">
            ...
            <input type="submit" class="btn btn-default boucher_code_button" onclick="voucher_code()" value="Apply Code"style="border-radius: 0 20px 20px 0 !important;">
            </span> </div>
          <div class="col-sm-12" id="discount_div_res_id"> </div>
          <!--</form>-->
