...
<div class="container ">
  <div class=" checkout-section">
    ...
    <div class="col-sm-12 col-md-8 col-lg-8 col-sx-12">
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-sx-12 customer-details">
          <form class="form-horizontal" name="login" id="login" autocomplete="off" action="<?php echo base_url('checkout/your_detail/'.$id);?>" method="POST">
            ...
            <div class="col-sm-6 col-md-6 col-sx-12 ">
              <div class=" form-group"> 
                ...
                <div class="col-md-8 col-lg-8 col-sx-12">
                  ...
                  <?php echo form_error('username1'); ?> </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-6 col-sx-12 ">
              <div class="  form-group">
            ...
            <div class=" col-sm-12 col-md-12 form-group"> <span  class="hoverd-btn span_your_detail_login_butn pull-right">
      ...
      <?php
		  ...
		  if(isset($row->id))
		  {
			 $desable_input_text='readonly="readonly"';
			 /*echo 'sadsadsad';
			 exit;*/
		  }
			/*print_r($row);
        ...
        <div class="col-sm-12 col-sx-12 customer-details">
          ...
          <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3">
              ...
              <?php echo form_error('customer_type'); ?> </div>
	...
	value="<?php echo set_value('delivery_address_street_address', isset($customer->formated_address) ? $customer->formated_address : '')?>" id="delivery_address_street_address" placeholder="Enter a Delivery street address"  size="50"  autocomplete="off">
              <?php echo form_error('delivery_address_street_address'); ?> </div>
          </div>
          <div class="form-group">
          ...
          <div id="dvAddress" style=" <?php  if(isset($row->id)){if($customer->same_as_billing_adddress){echo 'display: none;';}else{echo 'display: block;';}}else{echo 'display: none;';} if(isset($_POST['deliveryaddress']) && $_POST['deliveryaddress']==0){echo 'display: block;';}?>">
            <div class="form-group">
              ...
              <div class="col-md-9 col-sm-9"> 
                ...
                <?php echo form_error('billing_address'); ?> </div>
            </div>
            <div class="form-group">
              <label class="col-md-3 col-sm-3 control-label">Apartment/Unit</label>
              <div class="col-md-9 col-sm-9"> 
                ...
                <?php echo form_error('billing_apartment_no'); ?> </div>
            </div>
          </div>
 ...
 <a onclick='$("#order_popup").modal("show");'>Please check serviceable areas here</a> and update delivery address.</h4>
            ...
            <div class="form-group">
              <div class="col-md-4 col-sm-4 col-sm-offset-8"> <span class="hoverd-btn span_your_detail_login_butn pull-right">
    ...
    <div class="col-sm-6 col-md-4 col-lg-4 col-sx-8">
