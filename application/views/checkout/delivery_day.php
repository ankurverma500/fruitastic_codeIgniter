...
/*.delivery_day_level{padding:4px;}*/
</style>
<div class="container">
		  ...
		  /*echo '<pre>';
		   ...
		   ?>
            ...
            <div class="row" style="margin-top:100px;">
                      ...
                      <div class="form-group">
                          <label class="col-md-2 col-sm-2 control-label your_details_text_right">Packing notes </label>
                          <div class="col-md-6 col-sm-6">
            ...
            <div class="row">
                  <div class="col-sm-12 col-md-12 text-right checkout_btn_div customer-details" style="margin-top:20px;border: 1px solid #fff;  <?php if((!$run_detail) ||($run_detail['run_type']=='')||(count($run_detail['run'])<1) ){echo 'style="display:none;"';}?> "> 
