  ...
  <div class="banner_container terms_and-condition">
    <div class="banner_details text-center">
      <div class="container">
        <h1 class="animated fadeInDown go">Terms Of Sale</h1>
      </div>
    </div>
  </div>
  ...
  <div class="terms_and-condition_content">
  <div class="container">
      <div class="row">
          <div class="col-md-12 col-sm-12">
            <h1 class="terms_second_h_one">Terms and Conditions of Sale</h1>
            <hr>
            
            <h5 class="terms_and-condition-h">1. Sale and Purchase of Goods</h5>
            <p>Fruitastic ("Seller") hereby agrees to sell, and You ("Buyer") hereby agree to purchase, goods of the description and quantity described on the checkout window ("Checkout") and incorporated herein by this reference ("Goods") on the terms and conditions set forth in this Agreement.</p>
            <h5 class="terms_and-condition-h">2. Purchase Price</h5>
            <p>Buyer agrees to pay the Purchase Price of the Goods as posted on this website attached hereto.</p>
            <h5 class="terms_and-condition-h">3. Payment Terms</h5>
            <p>The total amount of the Purchase Price shall be payable in full by Buyer according to the payment due date stated at Checkout. Any portion of the Purchase Price unpaid past thirty (14) days shall be considered overdue. All amounts past due are subject to interest charges of 10% per annum of total value outstanding and a late fee of $35 per delivery service will apply for every (30) days overdue .  In addition, Seller shall have the right to pursue any remedies available at law or as provided herein and shall be entitled to reimbursement from Buyer for Seller's costs of collection, including attorney fees, legal fees and costs and disbursements.</p>
            <h5 class="terms_and-condition-h">4. Delivery</h5>
            ...
            <h5 class="terms_and-condition-h">5. Limited Warranty</h5>
            <p>Seller supplies as its sole warranty the following:</p>
            <p>We guarantee our produce 100% and will issue a refund or replacement in the next order for any piece of produce that isn't great. Must be made within one week of delivery.</p>
            <p>The warranty shall last for 1 week.</p>
            <p>The warranties provided for herein shall be governed by Seller's warranty policies in effect on the date of shipment.</p>
            <h5 class="terms_and-condition-h">6. Disclaimer of Warranty/Limitation of Liability</h5>
            ...
            <h5 class="terms_and-condition-h">7. Force Majeure</h5>
            ...
            <h5 class="terms_and-condition-h">8. General</h5>
            <p>Buyer may not assign this Agreement without Seller's written consent. Seller is the sole intended beneficiary of this Agreement. If there is any inconsistency between this Agreement and any other agreement included with or relating to the Goods, this Agreement shall govern. This Agreement may not be modified, altered or amended without the written agreement of Seller. Any additional or altered terms attached to any order submitted by Buyer shall be null and void, unless expressly agreed to in writing by Seller. If any term of this Agreement is illegal or unenforceable, the legality and enforceability of the remaining provisions shall not be affected or impaired. This Agreement shall be interpreted under the laws of Australia, without giving effect to conflicts-of-law rules; and in the event of a dispute under this Agreement; Buyer submits to the exclusive jurisdiction and venue of the courts of Australia and hereby waives any objection to such jurisdiction and venue</p>
